...
import logoImage from './Capture_d_écran_2024-04-22_161525-removebg-preview.ico';
    ...
    <>
      ...
      >
        ...
        <div className="md:w-64 border-r-2 border-gray-100 h-full flex-col flex flex-shrink-0">
          {/* Logo */}
          <SidebarLogo toggle={props.toggle}  text="Sunu Parrainages"  />
          ...
          <div className="pt-2 border-t border-gray-300">
            <div className="py-2 px-4">
              ...
              <button
                ...
                onClick={() => logout()}
              >
                <FontAwesomeIcon icon={faSignOut}></FontAwesomeIcon> Deconnexion
              </button>
            </div>
          </div>
        </div>
